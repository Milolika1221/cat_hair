...
**ВАЖНО:** т.к сервер не опубликован, то ark-версия приложения не покажет функционал нейросети. Для этого придется скачать приложение из ветви и изменить BASE_URL (изменить на свой IP).
